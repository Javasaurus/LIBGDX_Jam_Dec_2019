 ...
 * @author kenne
 */
public class SimpleChaseEnemy extends BaseEnemy {

    private static final Texture spriteSheet = new Texture(Gdx.files.internal("sprites/ships/enemy_04.png"));
    ...
    public SimpleChaseEnemy(Vector2 position, GameBehavior target, float sizeX, float sizeY) {
        super(sizeX, sizeY);
