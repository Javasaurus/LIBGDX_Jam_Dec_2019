 ...
 * @author kenne
 */
public class BasicBombEnemy extends BaseEnemy {

    private static final Texture spriteSheet = new Texture(Gdx.files.internal("sprites/ships/enemy_05.png"));
    ...
    public BasicBombEnemy(Vector2 position, GameBehavior target, float sizeX, float sizeY) {
        super(sizeX, sizeY);
